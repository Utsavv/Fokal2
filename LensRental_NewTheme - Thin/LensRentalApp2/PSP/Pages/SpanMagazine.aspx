...
<asp:Content ID="VendorPicture"  ContentPlaceHolderID="vendorPic" runat="server">
    <img height="200" width="355" alt="Vendor Poster" title="Vendor Poster" src="http://localhost:35475/PSP/Pages/../images/SpanMagazine.png" itemprop="image">
</asp:Content>
...
<asp:Content ID="upcomingEvents" ContentPlaceHolderID="UpcomingEvents" runat="server" >
    <ul>
        <li>
            <a href="http://fokal.in/PublishEvents/May2014/MyCommunityMyPlanetPhotoContest.aspx" >My Community My Planet - Photo Contest</a>
        </li>
        <li>
            <a href="" ></a>
        </li>
