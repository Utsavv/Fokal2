...
last course u would guess.. on portrait
...
<%-- Add the local link of the vendor in href--%>
    ...
    <span class="itemprop" itemprop="name">Nikon India</span>
...
last course u would guess.. on portrait.. how to create impressive portraits
<%--    <ul>
...
<asp:Content ID="EventWebPage" ContentPlaceHolderID="eventPage" runat="server">
    ...
    <a href="http://impressiveportraits.com" target="_blank">Visit </a><a href="http://impressiveportraits.com">Event Page</a>
</asp:Content>
...
<asp:Content ID="VendorEmail"  ContentPlaceHolderID="vendorEmail" runat="server">
    <a href="mailto:f@gmail.com"> f@gmail.com</a>
</asp:Content>
