...
Specialized course in fashion photography
</asp:Content>
...
Specialized course in fashion photography to make you move forward in your career
...
<%-- Add the local link of the vendor in href--%>
    ...
    <span class="itemprop" itemprop="name">IIP</span>
...
<asp:Content ID="EventWebPage" ContentPlaceHolderID="eventPage" runat="server">
    ...
    <a href="www.iipsc.com/courseonfashion" target="_blank">Visit </a><a href="www.iipsc.com/courseonfashion">Event Page</a>
</asp:Content>
...
<asp:Content ID="VendorEmail"  ContentPlaceHolderID="vendorEmail" runat="server">
    <a href="mailto:h@gmail.com"> h@gmail.com</a>
</asp:Content>
